<aside class="aside">
    ...
    <div class="aside-logo-container flex-center">

        <a href="#">
            <picture>
                <img src="{{ asset('images/V1/pages/admin/logo-w-t.png') }}" alt="">
            </picture>
        </a>

    </div>

    <ul class="flex-column gap-2 padding-y-5">
        ...
        <li>
            ...
            <div class="flex-column gap-1-5">
                ...
                <h2
                    class="font-size-1-6 white-space-nowrap aside-hide-on-no-active padding-x-1-5 color-grey font-semibold">
                    Menu principal
                </h2>
        ...
        <li>
            <div class="flex-column gap-1-5">
                ...
                <h2
                    class="font-size-1-6 white-space-nowrap padding-x-1-5 aside-hide-on-no-active color-grey font-semibold">
                    Formulários
                </h2>
